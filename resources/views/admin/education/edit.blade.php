...
@section('content')
    <div class="pb-3">
        <a href="{{ route('education.index') }}">Education</a> / Edit
    </div>
            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <input type="date" name="tgl_mulai" id="tgl_mulai" class="form-control form-control-sm"
                        placeholder="dd/mm/yyyy" value="{{ old('tgl_mulai') ?? $data->tgl_mulai }}">
                </div>
                <div class="col-auto">Tanggal Akhir</div>
                <div class="col-auto">
                    <input type="date" name="tgl_akhir" id="tgl_akhir" class="form-control form-control-sm"
                        placeholder="dd/mm/yyyy" value="{{ old('tgl_akhir') ?? $data->tgl_akhir }}">
                </div>
            </div>
        </div>
